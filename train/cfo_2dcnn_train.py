        ...
        if avg_val_loss < best_val_loss:
            ...
            if epochs_no_improve >= args.es_patience:
                ...
                torch.save(net.state_dict(),
                           "/home/leehyunjong/PycharmProjects/Machine_Learning/SNN/CFO/models/incomplete/cfo_2dcnn_wireless.pth")

                break

# torch.save(net.state_dict(), "/home/leehyunjong/PycharmProjects/Machine_Learning/SNN/CFO/models/incomplete/cfo_2dcnn_wireless.pth")
